...
> **Sample on GitHub** · `EUSTX50_1m.csv` (55,440 rows, `2026-06-01` -> `2026-09-01`, 5.37 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/eustx50)** — **2,836,357** `1m` rows, **11 timeframes**, `2012-08-27` -> `2026-09-01`.
